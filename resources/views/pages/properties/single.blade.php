        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s12 m4">
                    <div>
                        <h4 class="left">${{ $property->price }}@if($property->type === 'apartment' && $property->purpose === 'rent')<small>/mo</small>  @endif</h4>
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="content">
                                            <div class="author-name">
                                                ...
                                                @auth
                                                    <span id="commentreplay" class="right replay" data-commentid="{{ $comment->id }}">Reply</span>
                                                @endauth
